...
public class BaseService {
    ...
    protected Statement makeMYSQLDBConnection() {
        String dbName;
        String dbUser;
        String dbPw;
    ...
    protected void prepMYSQLDB(Statement statement) {
    ...
    protected void prepHSQLDB(Statement statement) {
        String dropTable = "DROP TABLE IF EXISTS Person";
    ...
    protected void savePerson(Statement statement) {
        String firstname;
        String lastname;
