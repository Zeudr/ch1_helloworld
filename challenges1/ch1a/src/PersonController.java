...
public class PersonController {
    ...
    public void process() {
        ...
        Statement statement = personRepository.makeDBConnection(String.format("jdbc:mysql://127.0.0.1:3306/%s", dbName), dbUser, dbPw);
        personRepository.checkDbConnection(statement);
        personRepository.prepDB(statement, true);
